...
class Main extends CI_Controller
{
	...
	public function index()
	{
		...
		$data['pasar'] = $this->db->query('SELECT * FROM pedagang INNER JOIN kategori WHERE pedagang.kategori = kategori.id_kategori GROUP BY pedagang.tempat_pasar ORDER BY pedagang.tempat_pasar ASC')->result_array();
