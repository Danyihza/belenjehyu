...
class Cari_model extends CI_Model
{
    public function cari(String $nama = null, String $kategori = null, String $pasar = null)
    {
        switch (TRUE) {
            case ($kategori == null):
                $query = "SELECT * FROM pedagang INNER JOIN kategori WHERE nama_pedagang LIKE '%$nama%' AND tempat_pasar = '$pasar' AND pedagang.kategori = kategori.id_kategori and pedagang.keterangan=1";
                break;
            case ($nama == null):
                $query = "SELECT * FROM pedagang INNER JOIN kategori WHERE nama_kategori = '$kategori' AND pedagang.kategori = kategori.id_kategori AND tempat_pasar = '$pasar' and pedagang.keterangan=1";
                break;
            case ($pasar == null):
                ...
                break;
            default:
                $query = "SELECT * FROM pedagang INNER JOIN kategori WHERE nama_pedagang LIKE '%$nama%' AND nama_kategori = '$kategori' AND pedagang.kategori = kategori.id_kategori AND tempat_pasar='$pasar' and pedagang.keterangan=1";
        }
        ...
        if ($nama == null && $kategori == null) {
            $query = "SELECT * FROM pedagang INNER JOIN kategori WHERE tempat_pasar ='$pasar' AND pedagang.kategori = kategori.id_kategori and pedagang.keterangan=1";
        } elseif ($nama == null && $pasar == null) {
            $query = "SELECT * FROM pedagang INNER JOIN kategori WHERE kategori.nama_kategori = '$kategori' AND pedagang.kategori = kategori.id_kategori and pedagang.keterangan=1";
        } elseif ($kategori == null && $pasar == null) {
            $query = "SELECT * FROM pedagang INNER JOIN kategori WHERE nama_pedagang LIKE '%$nama%' AND pedagang.kategori = kategori.id_kategori and pedagang.keterangan=1";
        }
